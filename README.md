...
Calypso is WordPress.com’s fresh, modern interface—a complete redesign of the WordPress dashboard as a sleek, single-page web app driven by the WordPress.com REST API. It enables users to easily read, write, and manage all their WordPress sites from a unified location.
